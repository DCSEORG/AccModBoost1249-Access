...
name: Access Mod Booster Agent
description: This agent will complete all the app mod tasks needed to turn the legacy Access DB App into a modern app using the legacy SQL schema as reference.
---
...
Most importantly you must use the .accdb file found in the legacy Database_Schema folder for the DB schema as well as buisness logic and also for the front end UI. This means you should ignore 
  the legacy screenshots and .sql file
